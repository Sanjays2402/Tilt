...
///
///     tilt-probe            stream the angle until interrupted
///     tilt-probe rate       measure how often the hardware value changes
///     tilt-probe record 60  every read for 60 s, with a wall clock stamp
///     tilt-probe watch 15   look for the angle rising while the lid closes
